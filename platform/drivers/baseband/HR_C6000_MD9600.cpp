...
void HR_Cx000< M >::init()
{
    ...
    writeReg(M::CONFIG, 0xA1, 0x00);    // FM_mod, all modes cleared
    writeReg(M::CONFIG, 0xC0, 0x0A);
    ...
    writeReg(M::CONFIG, 0x00, 0xFF);
    writeReg(M::CONFIG, 0x01, 0xB0);
    writeReg(M::CONFIG, 0x02, 0x00);
    writeReg(M::CONFIG, 0x03, 0x00);
    writeReg(M::CONFIG, 0x04, 0x00);
    writeReg(M::CONFIG, 0x05, 0x00);
